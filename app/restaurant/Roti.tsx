            ...
            <div>
                <div className="max-w-[800px] m-[20px_auto_0px] px-[20px]">
                    <div className="border-t-[16px] border-t-[rgba(2,6,12,.0509803922)]">{
                        ...
                        <div className={`m-[24px_16px_0_16px]  border-b-[.5px] border-b-[#d3d3d3] last:border-b-[0] ${item.img ? '' : 'pb-[16px]' }`} key={item.id}>
                            ...
                            <div className={`py-[4px] flex  ${item.img ? 'justify-between' : 'justify-between items-center' }`}>
                                <div>
                                ...
                                <div className={`flex flex-col items-center  ${item.img ? '' : 'justify-center ' }`}>
                                    ...
                                    <div className={` bottom-[20px]  flex flex-col  items-center ${item.img ? 'relative' : 'justify-center bottom-0 pr-[20px]' }`}>
                                        <div className="bg-[white] border-[rgba(2,6,12,0.15)] border-[1px] w-[120px] h-[40px] rounded-[8px] flex items-center justify-center">
                                            <span className="font-[gilroy-xbold] text-[18px] text-[rgb(27,166,114)] ">
                                                Add
                                            </span>
                                        </div>
