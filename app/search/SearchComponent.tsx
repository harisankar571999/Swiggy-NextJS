  ...
  return (
    <div>
       <Header/>
        ...
        <div className='w-[53%] mx-[auto] pt-[13px]'>
            <button className='w-[100%] p-[14px_16px] flex items-center gap-[15px]'>
                <div className='w-[64px] h-[64px] rounded-[4px]'>
                    <img src="/assets/dish.avif" alt="" className='w-[64px] h-[64px] rounded-[4px]'/>
                </div>
                <div className='flex flex-col items-start'>
                    <div className='font-[helvica-reg] font-[400] text-[14.98px] text-[#282c3f]'>Biriyani</div>
                    <div className='font-[helvica-reg]  font-[400] text-[14.98px] text-[#686b78]'>Dish</div>
                </div>
            </button>
        </div>
    </div>
