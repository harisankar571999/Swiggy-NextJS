                    ...
                    <div className="flex justify-between items-center ">
                        ...
                        <div className="relative">
                            <Link href={"search"} className="flex items-center gap-[8px]">
                                <button className="w-[360px] rounded-[12px] bg-[rgb(240,240,245)] h-[56px] p-[8px] text-[rgba(2,6,12,0.45)] text-left pl-[16px] text-[18px] font-[200] font-[gilroy-reg]">Search for restaurant and food</button>
