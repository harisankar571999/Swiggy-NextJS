  ...
  <>
    ...
    <div className="px-[20px]">
       <div className="p-[60px_0_8px_0] max-w-[1260px] mx-auto">
          <h1 className="font-[helvica-med] font-[600] text-[36px] text-[#282c3f] tracking-[1px]">{myData.category}</h1>
          <p className="font-[helvica-reg] font-[400] text-[18px] text-[#282c3f] mt-[8px] tracking-[.5px] opacity-[.9]">{myData.description}</p>
       </div>
    </div>
