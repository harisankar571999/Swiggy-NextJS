...
import NextArrow from "../../../../restaurants/_components/NextArrow"
import PrevArrow from "../../../../restaurants/_components/PrevArrow"
                ...
                <div className="block mr-[50px]" >
                    <div className="w-[323px] p-[12px] rounded-[20px] border-[rgba(2,6,12,0.15)] border-[1px] flex items-center gap-[12px] whitespace-nowrap " >
                        <div className="w-[48px] h-[48px]">
                            <Image width={48} height={48} src="/assets/restaurant/offer png.avif" alt="png.avif" className="object-cover" />
                        </div>
                        <div className="">
